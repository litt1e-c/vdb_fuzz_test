...
COLLECTION_NAME = "array_contains_operator_validation"
...
def main():
    ...
    try:
        ...
        tests = [
            ("int_contains_hit", "array_contains(int_arr, 2)", [1, 2, 6]),
            ("int_contains_miss", "array_contains(int_arr, 9)", []),
            ("bool_contains_true", "array_contains(bool_arr, true)", [1, 6]),
            ("str_contains_hit", 'array_contains(str_arr, "red")', [1, 6]),
            ("empty_array_false", "array_contains(int_arr, 1)", [1, 6]),
            ("raw_not_contains", "not (array_contains(int_arr, 2))", [3]),
        ]

        print("--- ARRAY_CONTAINS operator validation ---")
