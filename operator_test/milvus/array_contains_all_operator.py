...
COLLECTION_NAME = "array_contains_all_operator_validation"
...
def main():
    ...
    try:
        ...
        tests = [
            ("int_contains_all_subset", "array_contains_all(int_arr, [1, 2])", [1, 6]),
            ("int_contains_all_singleton", "array_contains_all(int_arr, [2])", [1, 2, 6]),
            ("bool_contains_all", "array_contains_all(bool_arr, [true, false])", [1]),
            ('str_contains_all', 'array_contains_all(str_arr, ["red", "blue"])', [1]),
            ("raw_not_contains_all", "not (array_contains_all(int_arr, [1, 2]))", [2, 3]),
        ]

        print("--- ARRAY_CONTAINS_ALL operator validation ---")
